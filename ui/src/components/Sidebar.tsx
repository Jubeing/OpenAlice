...
interface NavSection {
  sectionLabelKey: '' | 'sectionAgent' | 'sectionData' | 'sectionSystem'
  items: NavLeaf[]
}

function buildNavSections(t: NavLabels): NavSection[] {
  return [
    {
      sectionLabelKey: '',
      items: [
    ...
    {
      sectionLabelKey: 'sectionAgent',
      items: [
        {
          page: 'agent-status',
          labelKey: 'agentStatus',
          icon: (active) => (
            <svg width="18" height="18" viewBox="0 0 24 24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        ...
        <div className="mt-auto px-4 py-3 border-t border-border">
          <div className="flex items-center gap-2 text-[12px] text-text-muted">
            ...
            <span>{sseConnected ? t.nav.connected : t.nav.reconnecting}</span>
          </div>
        </div>
      </aside>
    </>
