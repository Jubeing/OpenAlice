...
export const tradingApi = {
  ...
  async refreshLongbridgeToken(appKey: string, appSecret: string, refreshToken: string): Promise<{ accessToken: string; refreshToken: string; expiresAt: string; error?: string }> {
